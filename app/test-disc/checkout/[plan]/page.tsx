...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Parsear la respuesta primero, independientemente del status
      let registerResult
      try {
      ...
      // Verificar si el usuario ya existe y redirigir al login
      if (registerResult.userExists && registerResult.redirectTo) {
        toast({
          title: "Usuario ya registrado",
          description: registerResult.error || "Este correo ya está registrado. Redirigiendo al inicio de sesión...",
          variant: "default",
        })
        
        // Esperar 2 segundos antes de redirigir
        setTimeout(() => {
          router.push(registerResult.redirectTo)
        }, 2000)
      ...
      if (!registerResponse.ok || !registerResult.success) {
        console.error("Error en la respuesta del servidor:", registerResult)
